...
If you have created a new project with `create nuxt-app` or `create-nuxt-app`, you can choose to add the content module and therefore it will be installed for you.
...
If you have created your project with `create nuxt-app` or `create-nuxt-app`, the `content/` directory will be already created.
